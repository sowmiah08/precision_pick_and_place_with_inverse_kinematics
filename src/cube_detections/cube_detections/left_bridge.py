...
MOTOR_ID_GRIPPER = 6
ACTION_NAME_ARM = '/so101_left_arm_controller/follow_joint_trajectory'
ACTION_NAME_GRIPPER = '/so101_left_gripper_controller/follow_joint_trajectory'

class LeftArmHardware(Node):

    def __init__(self):

        super().__init__('left_arm_hardware')
        ...
        self.gripper_joint_names = ['left_gripper']
    ...
    def execute_gripper_trajectory(self, goal_handle):
        ...
        try:
            gripper_idx = traj.joint_names.index('left_gripper')
        except ValueError as e:
